// Created on: Nov-2018
// Created by: Bradley Wills
// Created for: ICS3U
// This program will calculate the average of 10 generated numbers and create a label for each one whenever you click a button
...
class ViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        instructionsLabel.text = "Click the button to generate ten random numbers between 0 and 100 and find the highest."
        ...
        addButton.setTitle("Generate And Find Highest", for: UIControl.State.normal)
